#pragma checksum "C:\Assistence_Control\Assistence_Control\Menu\MasterPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "919F40E01D90C8F322B072663BFDDF63"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Assistence_Control.Menu
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MasterPage_obj2_Bindings :
            global::Windows.UI.Xaml.IDataTemplateExtension,
            global::Windows.UI.Xaml.Markup.IComponentConnector,
            IMasterPage_Bindings
        {
            private global::Assistence_Control.Menu.NavLink dataRoot;
            ...
            public MasterPage_obj2_Bindings()
            {
            }
            ...
            {
                 global::Assistence_Control.Menu.NavLink data = args.NewValue as global::Assistence_Control.Menu.NavLink;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::Assistence_Control.Menu.NavLink was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::Assistence_Control.Menu.NavLink);
                ...
                this.Update_((global::Assistence_Control.Menu.NavLink) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            // MasterPage_obj2_Bindings

            public void SetDataRoot(global::Assistence_Control.Menu.NavLink newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::Assistence_Control.Menu.NavLink obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MasterPage_obj1_Bindings :
            ...
            IMasterPage_Bindings
        {
            private global::Assistence_Control.Menu.MasterPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            // MasterPage_obj1_Bindings

            public void SetDataRoot(global::Assistence_Control.Menu.MasterPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Assistence_Control.Menu.MasterPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_NavLinks(global::System.Collections.ObjectModel.ObservableCollection<global::Assistence_Control.Menu.NavLink> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 8:
                {
                    this.fPrincipal = (global::Windows.UI.Xaml.Controls.Frame)(target);
                }
                break;
            case 9:
                {
                    this.splitViewToggle = (global::Windows.UI.Xaml.Controls.Button)(target);
                    #line 24 "..\..\..\Menu\MasterPage.xaml"
            ...
            case 2:
                {
                    ...
                    MasterPage_obj2_Bindings bindings = new MasterPage_obj2_Bindings();
                    returnValue = bindings;
                    bindings.SetDataRoot((global::Assistence_Control.Menu.NavLink) element2.DataContext);
